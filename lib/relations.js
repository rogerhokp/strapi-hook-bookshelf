...
module.exports = {
  ...
  addRelation: async function(params) {
    ...
    switch (association.nature) {
      ...
      case 'manyToMany': {
        await module.exports.fireBeforeAttach.call(this, params, association);
        return this.forge({
          [this.primaryKey]: params[this.primaryKey]
        })[association.alias]().attach(params.values[association.alias])
          .then(async (m) => {
            await module.exports.fireAfterAttach.call(this, params, association);
            return m;
          });
      }
      default:
  ...
  removeRelation: async function(params) {
    ...
    switch (association.nature) {
      ...
      case 'oneToMany':
      case 'manyToOne':
        return module.exports.update.call(this, _.set(params, ['values', association.alias], null));
      case 'manyToMany': {
        await module.exports.fireBeforeDetach.call(this, params, association);
        return this.forge({
          [this.primaryKey]: getValuePrimaryKey(params, this.primaryKey)
        })[association.alias]().detach(params.values[association.alias])
          .then(async (m) => {
            await module.exports.fireAfterDetach.call(this, params, association);
            return m;
          });
      }
      default:
  ...
  addRelationMorph: async function(params) {
    ...
    await module.exports.fireBeforeAttach.call(this, params);
    return await this.morph.forge({
      ...
      .save()
      .then(async (m) => {
        await module.exports.fireAfterAttach.call(this, params);
        return m;
      });
  },

  removeRelationMorph: async function(params) {
    await module.exports.fireBeforeDetach.call(this, params);
    return await this.morph.forge()
      .where(_.omitBy({
        [`${this.collectionName}_id`]: params.id,
        [`${params.alias}_id`]: params.refId,
      ...
      .destroy()
      .then(async (m) => {
        await module.exports.fireAfterDetach.call(this, params);
        return m;
      });
  },
  fireBeforeDetach: async function(params, association) {

    const beforeDetachFn = _.get(this, ['beforeDetachFromRelation']);
    if (beforeDetachFn && _.isFunction(beforeDetachFn)) {
      await beforeDetachFn(params.id, _.get(params, ['values', association.alias], null), association.alias);
    }
  },
  fireAfterDetach: async function(params, association) {
    const afterDetachFn = _.get(this, ['afterDetachFromRelation']);
    if (afterDetachFn && _.isFunction(afterDetachFn)) {
      await afterDetachFn(params.id, association ? _.get(params, ['values', association.alias], null) : null, association ? association.alias : null);
    }
  },
  fireBeforeAttach: async function(params, association) {

    const fn = _.get(this, ['beforeAttachFromRelation']);
    if (fn && _.isFunction(fn)) {
      await fn(params.id, _.get(params, ['values', association.alias], null), association.alias);
    }
  },
  fireAfterAttach: async function(params, association) {
    const fn = _.get(this, ['afterAttachFromRelation']);
    if (fn && _.isFunction(fn)) {
      await fn(params.id, association ? _.get(params, ['values', association.alias], null) : null, association ? association.alias : null);
    }
  },
};
