...
module.exports = {
      ...
      params.parseRelationships === false
        ...
        : Object.keys(removeUndefinedKeys(params.values)).reduce(
          async (acc, current) => {
            ...
            console.log('assocModel',assocModel);

            await module.exports.fireBeforeUpdate.call(this, params, association);
            ...
            await module.exports.fireAfterUpdate.call(this, params, association);
  ...
  async fireBeforeUpdate(params, association) {

    const fn = _.get(this, ['beforeRelationUpdate']);
    if (fn && _.isFunction(fn)) {
      await fn(params.id, _.get(params, ['values', association.alias], null), association.alias);
    }
  },
  async fireAfterUpdate(params, association) {
    const fn = _.get(this, ['afterRelationUpdate']);
    if (fn && _.isFunction(fn)) {
